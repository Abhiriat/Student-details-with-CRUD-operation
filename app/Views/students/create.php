...
<body>
    ...
    <form class="row g-3 border" action="<?=base_url('students/add')?>" method="POST">
...
<!--   
  ...
  <div class="col-md-2 my-2">
    ...
    <input type="text" name="Regular" class="form-control" id="Regular" required>
  </div>
  <div class="col-md-2 my-2">
  ...
  <input class="form-check-input" type="radio" name="leet" value='leet' id="leet1">
  <label class="form-check-label" for="leet">
    Leet
  </label>
</div>
<div class="form-check my-3">
  <input class="form-check-input" type="radio" name="leet" value='not leet' id="leet1" >
...
<div class="col-md-3 my-2">
    ...
    <input type="text" name="training" class="form-control" placeholder='yes/no' id="training" required>
  </div>
  <!-- <div class="col-12">
